...
class RangeSlider extends Component {
  ...
  // Set step for range slinder: Step =  25 % of max range
  _snap = (val, inc=(this._toPixelScale(this.props.max) / (100 / (this.props.step || 1)))) => {
    if (inc % 1 === 0){
      ...
      throw new Error(`Given step:  ${this.props.step} must be a divisor for: ${this.props.max}`);
    }
  };
