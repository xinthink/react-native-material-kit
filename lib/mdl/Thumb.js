...
// ## Thumb builder
//
class ThumbBuilder extends Builder {
  build() {
    const BuiltSlider = class extends Thumb {};
    BuiltSlider.defaultProps = Object.assign({}, Thumb.defaultProps, this.toProps());
    return BuiltSlider;
  }
}
...
//
function thumb() {
  return new ThumbBuilder().withBackgroundColor(MKColor.Transparent);
}

// define builder method for each prop
ThumbBuilder.defineProps(Thumb.propTypes);

// ## Public interface
module.exports = Thumb;
Thumb.thumb = thumb;
Thumb.Builder = ThumbBuilder;
