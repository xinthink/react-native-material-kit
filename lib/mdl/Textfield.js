...
import MKEditText from '../internal/MKEditText';
...
Textfield.propTypes = {
  // [MKEditText Props](../internal/MKEditText.html#props)...
  ...MKEditText.propTypes,
  ...
  // Style applied to the `MKEditText` component, ok to use `StyleSheet`
