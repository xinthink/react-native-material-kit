...
class FloatingLabel extends Component {
  ...
  _doMeasurement() {
    this.measure(this._onMeasured.bind(this));
  }
  ...
  setColor(color) {
    // FIXME failed on RN v0.12.0-rc, `cannot be converted to NSNumber`
...
class Textfield extends Component {
  ...
  render() {
    ...
    return (
      <View style={[defaultDim, this.props.style]} >
        <TextInput  // the input
          ref="input"
          {...inputProps}
          style={[{
            ...
            Textfield.defaultProps.textInputStyle,
