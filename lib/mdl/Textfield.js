...
class Textfield extends Component {
  ...
  render() {
    ...
    var errorColor = this.props.errorColor || "#f33535"
    var isError = this.props.errorText != null && this.props.errorText.length > 0
    var highlightColor = isError?errorColor:underlineProps.highlightColor
    return (
      <View style={this.props.style}>
        ...
        <Underline ref="underline"  // the underline
          {...underlineProps} highlightColor={highlightColor}
          underlineAniDur={this.props.floatingLabelAniDuration}
        />
      <View >
        <Text style={[{textAlign:'right',color:errorColor,
          marginTop:2,fontSize:12,height:31},this.props.errorStyle]}>{this.props.errorText}</Text>
        </View>
      </View>
    );
  }
